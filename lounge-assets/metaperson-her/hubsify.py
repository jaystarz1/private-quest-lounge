...
# Personal avatars are rendered close to the camera, but fifteen-plus
# 1024-square maps per avatar cost far more Quest GPU memory than their
# compressed GLBs suggest. A 512 cap preserves face detail while cutting
# decoded texture memory by roughly three quarters.
